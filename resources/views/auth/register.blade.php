        ...
        <div class="container">
            <div class="login-outer">
                <div class="login-image">
                    <img src="{{ url('assets/images/signup.webp') }}" class="img-fluid" alt="">
                </div>
                <div class="login-form">
                    <div class="form-box">
                        <h3>Sign Up</h3>
                        <p class="form-sub-heading">Sign Up for your account</p>
                            ...
                            <div class="filed-group">
                                ...
                                <div class="password-grp">
                                    <input type="password" id="password-field" name="password" placeholder="Password"
                                        required>
                                    <h6 class="fa fa-fw field-icon toggle-password"
                                        onclick="togglePasswordVisibility()"></h6>
                                </div>
                            </div>
                            <div class="filed-group">
                        ...
                        <p class="text-pass">Already have an account? <a href={{ route('login') }}>Log in</a></p>
                    </div>
                </div>
            </div>
        </div>
